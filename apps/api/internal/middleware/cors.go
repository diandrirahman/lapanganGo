...
func CORS() gin.HandlerFunc {
	...
	return func(c *gin.Context) {
		...
		c.Writer.Header().Set("Access-Control-Allow-Headers", "Content-Type, Content-Length, Accept-Encoding, X-CSRF-Token, Authorization, Idempotency-Key, X-Request-Deadline-Ms, accept, origin, Cache-Control, X-Requested-With")
