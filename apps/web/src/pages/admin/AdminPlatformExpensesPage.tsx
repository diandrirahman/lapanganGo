...
import { AlertCircle, BookOpen, ChevronLeft, ChevronRight, CircleDollarSign, Plus, RefreshCw, RotateCcw } from 'lucide-react';
...
const ExpenseList: React.FC<{ expenses: PlatformExpense[] }> = ({ expenses }) => (
  <>
    <div className="hidden overflow-hidden rounded-xl border border-slate-200 bg-white shadow-sm md:block">
      <div className="overflow-x-auto">
        <table className="min-w-full divide-y divide-slate-200">
          <thead className="bg-slate-50"><tr>
            {['Expense', 'Amount', 'When', 'Status', 'Journal link'].map((heading) => <th key={heading} className="px-5 py-3 text-left text-xs font-semibold uppercase tracking-wide text-slate-500">{heading}</th>)}
          </tr></thead>
